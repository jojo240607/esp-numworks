...
constexpr bool bitAtIndex(T mask, IN i) {
...
template <typename T, typename IN>
constexpr T bitsBetweenIndexes(T bits, IN high, IN low) {
...
template <typename T, typename IN>
constexpr void setBitsBetweenIndexes(T& bits, IN high, IN low, T value) {
...
template <typename T, typename IN>
constexpr void setBitAtIndex(T& mask, IN i, bool b) {
