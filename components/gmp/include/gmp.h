...
#define __GMP_CC "xtensa-esp32s3-elf-gcc"
#define __GMP_CFLAGS "-mlongcalls -ffunction-sections -fdata-sections -Wno-error=unused-variable -Wno-error=unused-function -DESP_PLATFORM -DHAVE_CONFIG_H -DXTENSA -fno-strict-aliasing -fno-threadsafe-statics -fno-exceptions -fno-use-cxa-atexit -Os -DNDEBUG -fdata-sections -ffunction-sections -flto -fno-fat-lto-objects -flto-partition=none -fwhole-program -fvisibility=internal -I/d/projects/mcu/clion/makefile/github/khicas/output/libs/include --specs=nosys.specs"
