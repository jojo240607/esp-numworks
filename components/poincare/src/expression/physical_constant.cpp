...
const PhysicalConstant::Properties PhysicalConstant::k_constants[] = {
    ...
    Properties{"_me", 9.1093837139e-31, kg},
    Properties{"_mn", 1.67492750056e-27, kg},
    Properties{"_mp", 1.67262192595e-27, kg},
    Properties{"_Na", 6.02214076e23, mol ^ -1},
    Properties{"_R", 8.31446261815324, (J * (mol ^ -1) * (K ^ -1))},
    Properties{"_ε0", 8.8541878188e-12, F / m},
    Properties{"_μ0", 1.25663706127e-6, (N * (A ^ -2))},
